...
export default function processExceptionEvents(data) {
...
export function saveExceptionDataToMemory(memoryObject, deviceID, data) {
  ...
  const initExceptionEnd = createObjectKeyIfNotExist(deviceObject[start], end);
  // createKeyArrayIfNotExist(deviceObject[start], 'orderedDateTimes');
  // if (initExceptionEnd) {
  //    insertIntoOrderedArray(deviceObject[start].orderedDateTimes, end);
  // };
